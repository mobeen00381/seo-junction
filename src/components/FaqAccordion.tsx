...
const FAQS = [
  ...
  { q:'How much does SEO Junction cost?', a:'Plans start at $19/month after a 30-day free trial. The domain setup is a one-time $19 fee. No contracts — cancel anytime.' },
]
