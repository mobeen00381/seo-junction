...
const FAQS = [
  { q:'How does Neerzy help local businesses rank on Google?', a:'We build a fast SEO-optimized website and manage your Google Business Profile. Our AI posts fresh content to your site and GMB every month — the two biggest local ranking signals Google uses.' },
  { q:'What types of businesses does Neerzy work for?', a:'Any local service business — plumbers, electricians, HVAC, roofers, landscapers, dentists, and more. If customers search Google to find you, Neerzy will help you show up.' },
