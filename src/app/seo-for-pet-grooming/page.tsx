...
export const metadata: Metadata = {
  title: 'SEO for Pet Groomers — Every Job Becomes a Google Post and a 5-Star Review',
  description: 'Neerzy helps pet groomers rank for "dog grooming near me". Turn every grooming session into an automated post and a 5-star review. Free to start.',
  keywords: 'SEO for pet groomers, dog grooming marketing, rank pet grooming Google, cat grooming SEO, pet groomer near me',
  openGraph: {
    title: 'SEO for Pet Groomers | Neerzy — Every Job Becomes a Google Post and a 5-Star Review',
    description: 'Automate your pet grooming salon growth. Every session becomes a Google post and a 5-star review automatically.',
    url: 'https://www.neerzy.com/seo-for-pet-grooming',
  },
}
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 font-inter text-left">
      ...
      <section style={{background:'linear-gradient(135deg,#EC4899,#BE185D)'}} className="px-6 py-40 text-center text-white">
        <div className="max-w-3xl mx-auto">
          <div className="inline-block text-[10px] font-black tracking-[2px] uppercase px-4 py-1.5 rounded-full mb-6 border" style={{background:'rgba(255,255,255,0.1)',borderColor:'rgba(255,255,255,0.2)',color:'#FCE7F3'}}>ðŸ© Local Pet Visibility</div>
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight tracking-tight text-center">
            Pawsome Growth for <br /><span className="text-pink-200">Local Groomers</span> â€” 100% Autopilot
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/onboarding" className="font-bold text-pink-900 bg-white px-8 py-4 rounded-xl text-base shadow-xl hover:bg-pink-50 transition-all">Start 30-Day Free Trial â†’</Link>
      ...
      <section className="py-24 px-6 bg-gray-50 dark:bg-slate-900/50">
        <div className="max-w-4xl mx-auto text-left">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {icon:'ðŸ•',title:'Breed-Specific SEO',desc:'We target high-intent searches like "Golden Retriever grooming", "cat hair removal", and "puppy first trim" to drive local owner calls.'},
              {icon:'âœ‚ï¸',title:'Grooming Authority',desc:'Our AI automatically posts hygiene tips and deshedding explanations, building your trust before the pet even enters your salon.'},
              {icon:'ðŸ—ºï¸',title:'Map Pack Presence',desc:'Pet owners look for proximity. We ensure your hours, location, and pet categories are hyper-optimized to stay at the top.'},
            ].map((p,i)=>(
      ...
      <section className="py-20 px-6 bg-white dark:bg-slate-950 border-t border-gray-100 dark:border-slate-800">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link href="/onboarding" className="inline-block font-bold text-white px-12 py-5 rounded-2xl shadow-2xl transition-all hover:scale-105" style={{background:'var(--premium-gradient)'}}>Start Free Trial â€” Built for Groomers â†’</Link>
