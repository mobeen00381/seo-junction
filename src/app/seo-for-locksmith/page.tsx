...
export const metadata: Metadata = {
  title: 'SEO for Locksmiths — Every Job Becomes a Google Post and a 5-Star Review',
  description: 'Neerzy helps locksmiths dominate the Google Map Pack. Turn every emergency lockout and security install into an automated post and a 5-star review. Free to start.',
  keywords: 'SEO for locksmiths, locksmith GMB marketing, rank locksmith near me, emergency locksmith SEO, locksmith calls',
  openGraph: {
    title: 'SEO for Locksmiths | Neerzy — Every Job Becomes a Google Post and a 5-Star Review',
    description: 'Automate your locksmith business growth. Every lockout and security job becomes a Google post and a 5-star review automatically.',
    url: 'https://www.neerzy.com/seo-for-locksmith',
  },
}
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 font-inter text-left">
      ...
      <section style={{background:'linear-gradient(135deg,#0F172A,#1E293B)'}} className="px-6 py-40 text-center text-white">
        <div className="max-w-3xl mx-auto">
          <div className="inline-block text-[10px] font-black tracking-[2px] uppercase px-4 py-1.5 rounded-full mb-6 border" style={{background:'rgba(245,158,11,0.2)',borderColor:'rgba(245,158,11,0.4)',color:'#FCD34D'}}>ðŸ”‘ Rapid Locksmith SEO</div>
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight tracking-tight text-center">
            The Number #1 Choice For <br /><span className="text-amber-400">Emergency Calls</span> â€” Rank #1
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/onboarding" className="font-bold text-slate-900 bg-white px-8 py-4 rounded-xl text-base shadow-xl hover:bg-slate-50 transition-all">Start 30-Day Free Trial â†’</Link>
      ...
      <section className="py-24 px-6 bg-gray-50 dark:bg-slate-900/50">
        <div className="max-w-4xl mx-auto text-left">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {icon:'ðŸš—',title:'Auto Lockout AI',desc:'We target high-intent searches like "car key replacement", "fob programming", and "unlock car near me" to capture high-value automotive calls.'},
              {icon:'ðŸ ',title:'Residential Trust',desc:'Our AI automatically posts security tips and rekeying explanations, building your authority as the safest locksmith in the neighborhood.'},
              {icon:'ðŸ¢',title:'Commercial Leads',desc:'We use professional security terms like "master key systems", "panic bars", and "access control" to reach business owners.'},
            ].map((p,i)=>(
