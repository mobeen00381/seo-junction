...
export const metadata: Metadata = {
  title: 'SEO for Dentists — Every Job Becomes a Google Post and a 5-Star Review',
  description: 'Neerzy helps dentists rank on Google Maps and local search. Turn every treatment into an automated post and a 5-star review. Free to start.',
  ...
  openGraph: {
    title: 'SEO for Dentists | Neerzy — Every Job Becomes a Google Post and a 5-Star Review',
    description: 'Automate your dental clinic growth. Every treatment becomes a Google post and a 5-star review automatically.',
    url: 'https://www.neerzy.com/seo-for-dentists',
  },
}
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 font-inter">
      ...
      <section style={{background:'linear-gradient(135deg,#0E7490,#155E75)'}} className="px-6 py-40 text-center text-white">
        <div className="max-w-3xl mx-auto">
          <div className="inline-block text-[10px] font-black tracking-[2px] uppercase px-4 py-1.5 rounded-full mb-6 border" style={{background:'rgba(255,255,255,0.1)',borderColor:'rgba(255,255,255,0.2)'}}>ðŸ¦· Dentistry Growth Engine</div>
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight tracking-tight text-center">
            Fill Your Calendar with <br /><span className="text-cyan-300">New Patients</span> â€” 100% On Autopilot
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/onboarding" className="font-bold text-cyan-900 bg-white px-8 py-4 rounded-xl text-base shadow-xl hover:bg-cyan-50 transition-all">Start 30-Day Free Trial â†’</Link>
      ...
      <section className="py-24 px-6 bg-gray-50 dark:bg-slate-900/50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {icon:'ðŸ¦·',title:'Emergency Ranking',desc:'When someone has a toothache, they donâ€™t wait. We ensure you show up #1 for emergency dental searches in your exact neighborhood.'},
              {icon:'ðŸ’‰',title:'Treatment Education',desc:'Our AI automatically posts hygiene tips and treatment explanations to your site, building trust with patients before they even call.'},
              {icon:'ðŸ“…',title:'Hygiene Recalls',desc:'We emphasize the importance of regular cleanings through seasonal Google posts, keeping your existing patients coming back.'},
            ].map((p,i)=>(
      ...
      <section className="py-20 px-6 bg-white dark:bg-slate-950 border-t border-gray-100 dark:border-slate-800">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link href="/onboarding" className="inline-block font-bold text-white px-12 py-5 rounded-2xl shadow-2xl transition-all hover:scale-105" style={{background:'var(--premium-gradient)'}}>Start Free Trial â€” Built for Dentists â†’</Link>
