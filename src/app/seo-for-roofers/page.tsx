    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 font-inter text-left">
      ...
      <section style={{background:'linear-gradient(135deg,#0F172A,#334155)'}} className="px-6 py-40 text-center text-white">
        <div className="max-w-3xl mx-auto">
          <div className="inline-block text-[10px] font-black tracking-[2px] uppercase px-4 py-1.5 rounded-full mb-6 border" style={{background:'rgba(245,158,11,0.2)',borderColor:'rgba(245,158,11,0.4)',color:'#FCD34D'}}>ðŸ  High-Authority Roofing SEO</div>
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight tracking-tight text-center text-white">
            The Number #1 Choice For <br /><span className="text-amber-400">Roofing Leads</span> â€” 100% Autopilot
          </h1>
      ...
      <section className="py-24 px-6 bg-gray-50 dark:bg-slate-900/50">
        <div className="max-w-4xl mx-auto text-left">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {icon:'â›ˆï¸',title:'Storm Damage Leads',desc:'We target high-intent searches like "emergency roof repair", "hail damage estimate", and "shingle replacement" to capture immediate local calls.'},
              {icon:'ðŸ˜ï¸',title:'Residential Authority',desc:'Our AI automatically posts material reviews and installation guides (asphalt, metal, tile), building trust with families in your area.'},
              {icon:'ðŸ—ï¸',title:'Commercial Roofing',desc:'We use professional roofing terms like "EPDM membrane", "TPO roofing", and "flat roof coatings" to reach business owners.'},
            ].map((p,i)=>(
