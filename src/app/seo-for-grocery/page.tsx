...
export const metadata: Metadata = {
  title: 'SEO for Grocery Stores — Every Job Becomes a Google Post and a 5-Star Review',
  description: 'Neerzy helps local grocery stores rank for "fresh produce near me". Turn every weekly special and new arrival into an automated post and a 5-star review. Free to start.',
  keywords: 'SEO for grocery stores, local supermarket marketing, rank grocery store Google, fresh produce SEO, grocery near me',
  openGraph: {
    title: 'SEO for Grocery Stores | Neerzy — Every Job Becomes a Google Post and a 5-Star Review',
    description: 'Be the first choice for fresh groceries. Every special and arrival becomes a Google post automatically.',
    url: 'https://www.neerzy.com/seo-for-grocery',
  },
}
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 font-inter">
      ...
      <section style={{background:'linear-gradient(135deg,#064E3B,#065F46)'}} className="px-6 py-40 text-center text-white">
        <div className="max-w-3xl mx-auto">
          <div className="inline-block text-[10px] font-black tracking-[2px] uppercase px-4 py-1.5 rounded-full mb-6 border" style={{background:'rgba(16,185,129,0.2)',borderColor:'rgba(16,185,129,0.4)',color:'#A7F3D0'}}>ðŸŽ Fresh Local Visibility</div>
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight tracking-tight text-center">
            Be the First Choice for <br /><span className="text-emerald-300">Fresh Groceries</span> â€” In Your Town
          </h1>
      ...
      <section className="py-24 px-6 bg-gray-50 dark:bg-slate-900/50">
        <div className="max-w-4xl mx-auto text-left">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {icon:'ðŸ¥‘',title:'Fresh Produce Keywords',desc:'We target high-intent searches like "organic vegetables", "fresh bakery", and "local deli" to drive foot traffic to your aisles.'},
              {icon:'ðŸ“¢',title:'Weekly Specials',desc:'Our AI automatically updates your Google profile with "Deal of the Week" posts, ensuring locals see your best prices first.'},
              {icon:'ðŸ—ºï¸',title:'Map Pack Presence',desc:'We ensure your store hours, phone number, and location are hyper-optimized to show up in the critical Map Pack 3-spot.'},
            ].map((p,i)=>(
      ...
      <section className="py-20 px-6 bg-white dark:bg-slate-950 border-t border-gray-100 dark:border-slate-800">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link href="/onboarding" className="inline-block font-bold text-white px-12 py-5 rounded-2xl shadow-2xl transition-all hover:scale-105" style={{background:'var(--premium-gradient)'}}>Start Free Trial â€” Built for Grocers â†’</Link>
