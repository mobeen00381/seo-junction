...
export const metadata: Metadata = {
  title: 'SEO for Cleaning Services — Every Job Becomes a Google Post and a 5-Star Review',
  description: 'Neerzy helps cleaning companies rank for "house cleaning near me" and "commercial janitorial". Turn every job into an automated post and a 5-star review. Free to start.',
  ...
  openGraph: {
    title: 'SEO for Cleaning Services | Neerzy — Every Job Becomes a Google Post and a 5-Star Review',
    description: 'Automate your cleaning business growth. Every job becomes a Google post and a 5-star review automatically.',
    url: 'https://www.neerzy.com/seo-for-cleaning',
  },
}
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 font-inter text-left text-gray-900 dark:text-white">
      ...
      <section className="py-20 px-6 bg-white dark:bg-slate-950 border-t border-gray-100 dark:border-slate-800">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-500 dark:text-gray-400 mb-4 text-center uppercase tracking-widest font-bold font-inter">Launch your real business online — your own domain, for a one-time <span className="text-gray-900 dark:text-white">£29/$29</span> setup fee.</p>
          <p className="text-sm text-gray-400 dark:text-gray-500 mb-10 text-center italic max-w-md mx-auto">This is your business. Your name on the door. Yours forever — even if you leave Neerzy.</p>
