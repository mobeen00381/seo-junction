...
export const metadata: Metadata = {
  title: 'Sanitary & Tiles SEO — Every Job Becomes a Google Post and a 5-Star Review',
  description: 'Neerzy helps sanitary stores rank for luxury tiles and bathroom fittings. Turn every showroom update into an automated post and a 5-star review. Free to start.',
  ...
  openGraph: {
    title: 'Sanitary & Tiles SEO | Neerzy — Every Job Becomes a Google Post and a 5-Star Review',
    description: 'Transform your showroom traffic automatically. Every project becomes a Google post and a 5-star review.',
    url: 'https://www.neerzy.com/seo-for-sanitary',
  },
}
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 font-inter">
      ...
      <section style={{background:'linear-gradient(135deg,#1E293B,#0F172A)'}} className="px-6 py-40 text-center text-white">
        <div className="max-w-3xl mx-auto">
          <div className="inline-block text-[10px] font-black tracking-[2px] uppercase px-4 py-1.5 rounded-full mb-6 border" style={{background:'rgba(148,163,184,0.1)',borderColor:'rgba(148,163,184,0.3)',color:'#CBD5E1'}}>ðŸš¿ Luxury Showroom SEO</div>
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight tracking-tight text-center text-white">
            Transform Your <br /><span className="text-indigo-400">Showroom Traffic</span> â€” Automatically
          </h1>
      ...
      <section className="py-24 px-6 bg-gray-50 dark:bg-slate-900/50">
        <div className="max-w-4xl mx-auto text-left">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {icon:'ðŸ’Ž',title:'Luxe Term Targeting',desc:'We use AI to target specific sanitary terms like "anti-skid tiles", "one-piece closet", and "designer faucets" to reach high-value buyers.'},
              {icon:'ðŸ–¼ï¸',title:'Showroom Showcase',desc:'Our AI automatically posts new catalog highlights and design inspiration to your Google profile, keeping your showroom visible to locals.'},
              {icon:'ðŸ—ºï¸',title:'Map Pack Presence',desc:'Sanitary stores live in the Map Pack. We ensure your hours, showroom address, and product categories are always #1.'},
            ].map((p,i)=>(
      ...
      <section className="py-20 px-6 bg-white dark:bg-slate-950 border-t border-gray-100 dark:border-slate-800">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link href="/onboarding" className="inline-block font-bold text-white px-12 py-5 rounded-2xl shadow-2xl transition-all hover:scale-105" style={{background:'var(--premium-gradient)'}}>Start Free Trial â€” Built for Sanitary â†’</Link>
