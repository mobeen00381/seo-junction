    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 font-inter">
      ...
      <section className="py-20 px-6 bg-white dark:bg-slate-950 border-t border-gray-100 dark:border-slate-800">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-indigo-600 dark:text-indigo-400 mb-10 text-center uppercase tracking-widest font-bold font-inter">Get Your Store Live For Only <span className="text-gray-900 dark:text-white">$19.99 One-Time</span></p>
