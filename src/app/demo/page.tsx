...
export default function DemoHubPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* ── NAV ── */}
      <nav className="bg-white border-b border-gray-100 px-6 py-6 flex justify-between items-center sticky top-0 z-50">
        ...
        <Link href="/onboarding" className="text-sm font-bold text-white px-6 py-3 rounded-xl shadow-lg shadow-blue-100 hover:opacity-90 transition-all bg-navy">
          Back to Onboarding
        </Link>
      </nav>
      ...
      <section className="px-6 py-24 text-center bg-gray-50 border-b border-gray-100">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 leading-tight">
            See What Your Website <br /><span className="text-blue-600 font-bold">Will Look Like</span>
          </h1>
              ...
              <div key={i} className="group relative rounded-3xl overflow-hidden border border-gray-100 bg-white shadow-xl shadow-gray-100 transition-all hover:-translate-y-2 hover:shadow-2xl">
                ...
                <div className="p-10">
                  <div className="flex justify-between items-start mb-6">
                    <div>
                      <h3 className="text-2xl font-bold text-gray-900 mb-2">{d.name}</h3>
                      <p className="text-sm text-gray-400 font-semibold">{d.trade} · {d.city}</p>
                    </div>
                  </div>
                  ...
                  {/* RESULTS BADGE */}
                  <div className="bg-emerald-50 text-emerald-700 rounded-2xl px-6 py-4 mb-10 border border-emerald-100">
      ...
      {/* ── BOTTOM CTA ── */}
      <section className="py-24 px-6 text-center border-t border-gray-100 bg-gray-50">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Ready to Build Your Own?</h2>
          <p className="text-gray-600 mb-12 text-lg">Select your trade, and your site will be live within 24 hours.</p>
          <Link href="/onboarding" className="inline-block font-bold text-white px-12 py-5 rounded-3xl text-lg shadow-xl shadow-blue-200 hover:scale-105 transition-all bg-navy">
            Start Free Trial Today
          </Link>
          <p className="text-xs text-gray-400 mt-10 font-bold uppercase tracking-widest">30-day free trial • Cancel anytime • No tech skills needed</p>
        </div>
      </section>
