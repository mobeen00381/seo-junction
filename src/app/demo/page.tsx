  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="bg-white border-b px-6 py-4 flex justify-between items-center sticky top-0 z-40 shadow-sm">
        <div className="font-black text-gray-900 text-lg" style={{fontFamily:'Syne, sans-serif'}}>Elite Plumbing Pro</div>
      ...
      <section id="services" className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-black text-gray-900 mb-2" style={{ fontFamily: 'Syne, sans-serif' }}>Plumbing Services in Austin, TX</h2>
      ...
      <section className="py-12 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl font-black text-gray-900 mb-3" style={{ fontFamily: 'Syne, sans-serif' }}>Serving South Congress, Austin & Surrounding Areas</h2>
      ...
      <section id="reviews" className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-black text-center text-gray-900 mb-10" style={{ fontFamily: 'Syne, sans-serif' }}>What Austin Customers Say</h2>
          <div className="grid md:grid-cols-3 gap-5">
            {[
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-black text-center text-gray-900 mb-8" style={{fontFamily:'Syne, sans-serif'}}>Austin Plumbing Costs — 2025 Rates</h2>
      ...
      <section id="faq" className="py-16 px-6">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-2xl font-black text-center text-gray-900 mb-8" style={{fontFamily:'Syne, sans-serif'}}>Questions About Austin Plumbers</h2>
      ...
      <section style={{background:'#1B1B2F'}} className="py-16 px-6 text-center">
        <h2 className="text-3xl font-black text-white mb-3" style={{fontFamily:'Syne, sans-serif'}}>Need a Plumber in Austin Right Now?</h2>
